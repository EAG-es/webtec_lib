...
public class Utf8 {
    ...
    /**
     * Abre un archivo UTF8 para escribir
     * @param file Archivo que abrir
     * @param es_escribir_al_final Si se abre para añadirle texto, o se escribe desde el principio.
     * @param error Mensaje de error, si lo hay
     * @return El objeto para escribir; o null, si hay error.
     */
    public static PrintStream abrir(File file, boolean es_escribir_al_final, String [] error)
    {
        boolean ret = true;  
        FileOutputStream fileOutputStream;
        PrintStream printStream = null; 
        try {
            fileOutputStream = new FileOutputStream(file, es_escribir_al_final);
            printStream = new PrintStream(fileOutputStream, true, "UTF-8"); //NOI18N
        } catch (Exception e) {
            error[0] = e.getMessage();
            if (error[0] == null) {
            ...
            error[0] = "Error en abrir. " + error[0];
            ret = false;
            printStream = null;
        }
        return printStream;
